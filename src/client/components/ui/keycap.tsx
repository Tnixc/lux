...
import { ArrowUp, ArrowDown, ArrowLeft, ArrowRight, CornerDownLeft, Command } from 'lucide-react'
...
export const Keycap = memo(function Keycap({ keyName, className, size = 'sm' }: KeycapProps) {
  ...
  return (
    ...
    >
      {typeof content === 'string' ? content : <content.icon className={iconSizes[size]} />}
    </kbd>
  )
})
